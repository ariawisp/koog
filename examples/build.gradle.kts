...
registerRunExampleTask("runExampleStructuredOutput", "ai.koog.agents.example.structuredoutput.StructuredOutputExampleKt")
registerRunExampleTask("runExampleAdvancedSimpleStructuredOutput", "ai.koog.agents.example.structuredoutput.AdvancedSimpleStructuredOutputExampleKt")
registerRunExampleTask("runExampleAdvancedFullStructuredOutput", "ai.koog.agents.example.structuredoutput.AdvancedFullStructuredOutputExampleKt")
registerRunExampleTask("runExampleMarkdownStreaming", "ai.koog.agents.example.structuredoutput.MarkdownStreamingDataExampleKt")
registerRunExampleTask("runExampleMarkdownStreamingWithTool", "ai.koog.agents.example.structuredoutput.MarkdownStreamingWithToolsExampleKt")
