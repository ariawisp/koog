...
internal object BedrockAmazonNovaConverter {
    ...
    internal fun parseNovaResponse(responseBody: String, clock: Clock = Clock.System): List<Message.Response> {
        val response = bedrockJson.decodeFromString<NovaResponse>(responseBody)
    ...
    internal fun parseNovaStreamChunk(chunkJsonString: String): String {
        val chunk = bedrockJson.decodeFromString<NovaStreamChunk>(chunkJsonString)
