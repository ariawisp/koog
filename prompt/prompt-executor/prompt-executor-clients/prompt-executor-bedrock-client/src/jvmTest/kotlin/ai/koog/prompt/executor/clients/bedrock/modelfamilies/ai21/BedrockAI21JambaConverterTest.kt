...
class BedrockAI21JambaConverterTest {
    ...
    fun `createJambaRequest with basic prompt`() {
        ...
        val request = BedrockAI21JambaConverter.createJambaRequest(prompt, model, emptyList())
    ...
    fun `createJambaRequest respects model temperature capability`() {
        ...
        val request = BedrockAI21JambaConverter.createJambaRequest(promptWithTemperature, model, emptyList())
        assertEquals(temperature, request.temperature)
        ...
        val requestWithoutTemp = BedrockAI21JambaConverter.createJambaRequest(
    ...
    fun `parseJambaResponse with text content`() {
        ...
        val messages = BedrockAI21JambaConverter.parseJambaResponse(responseJson, mockClock)
    ...
    fun testParseJambaStreamChunk() {
        ...
        val content = BedrockAI21JambaConverter.parseJambaStreamChunk(chunkJson)
