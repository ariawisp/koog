...
class BedrockMetaLlamaConverterTest {
    ...
    fun `createLlamaRequest respects model temperature capability`() {
        ...
        val request = BedrockMetaLlamaConverter.createLlamaRequest(promptWithTemperature, model)
        assertEquals(temperature, request.temperature)
        ...
        val requestWithoutTemp =
            BedrockMetaLlamaConverter.createLlamaRequest(promptWithTemperature, modelWithoutTemperature)
    ...
    fun testParseLlamaResponse() {
        ...
        val messages = BedrockMetaLlamaConverter.parseLlamaResponse(responseJson, mockClock)
    ...
    fun testParseLlamaStreamChunk() {
        ...
        val content = BedrockMetaLlamaConverter.parseLlamaStreamChunk(chunkJson)
