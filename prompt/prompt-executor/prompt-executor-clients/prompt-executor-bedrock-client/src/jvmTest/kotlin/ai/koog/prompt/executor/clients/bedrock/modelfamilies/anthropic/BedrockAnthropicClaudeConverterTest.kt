...
class BedrockAnthropicClaudeConverterTest {
    ...
    fun `createAnthropicRequest with basic prompt`() {
        ...
        val request = BedrockAnthropicClaudeConverter.createAnthropicRequest(prompt, model, emptyList())
    ...
    fun `createAnthropicRequest with different tool choices`() {
        ...
        val requestAuto = BedrockAnthropicClaudeConverter.createAnthropicRequest(promptAuto, model, tools)
        ...
        val requestNone = BedrockAnthropicClaudeConverter.createAnthropicRequest(promptNone, model, tools)
        ...
        val requestRequired = BedrockAnthropicClaudeConverter.createAnthropicRequest(promptRequired, model, tools)
        ...
        val requestNamed = BedrockAnthropicClaudeConverter.createAnthropicRequest(promptNamed, model, tools)
    ...
    fun `parseAnthropicResponse with text content`() {
        ...
        val messages = BedrockAnthropicClaudeConverter.parseAnthropicResponse(responseJson, mockClock)
    ...
    fun `parseAnthropicStreamChunk with content_block_delta`() {
        ...
        val content = BedrockAnthropicClaudeConverter.parseAnthropicStreamChunk(chunkJson)
