...
class BedrockAmazonNovaConverterTest {
    ...
    fun `createNovaRequest respects model temperature capability`() {
        ...
        val request = BedrockAmazonNovaConverter.createNovaRequest(promptWithTemperature, model)
        assertEquals(temperature, request.inferenceConfig?.temperature)
        ...
        val requestWithoutTemp = BedrockAmazonNovaConverter.createNovaRequest(
    ...
    fun testParseNovaResponse() {
        ...
        val messages = BedrockAmazonNovaConverter.parseNovaResponse(responseJson, mockClock)
    ...
    fun testParseNovaStreamChunk() {
        ...
        val content = BedrockAmazonNovaConverter.parseNovaStreamChunk(chunkJson)
