...
class OpenAISimpleJsonSchemaGeneratorTest {
    ...
    private val simpleGenerator = OpenAISimpleJsonSchemaGenerator
    ...
    @Test
    fun testGenerateOpenAISimpleJsonSchemaWeatherForecast() {
