...
/**
 * Simple implementation of [GenericJsonSchemaGenerator] that produces [ai.koog.prompt.params.LLMParams.Schema.JSON.Simple].
...
public open class SimpleJsonSchemaGenerator : GenericJsonSchemaGenerator() {
    ...
    /**
     * Default instance of [SimpleJsonSchemaGenerator].
     * Prefer to use it instead of creating new instates manually.
     *
     * @see [SimpleJsonSchemaGenerator]
     */
    ...
    override fun generate(
        ...
        return LLMParams.Schema.JSON.Simple(
            name = name,
            schema = schema,
        )
    }
